...
class SplashAnimation extends React.Component{
    handleClick(){
        this.props.action({ email: 'ruby@gmail.com', password: 'password' }).then(() => this.props.history.push('/signin'))
        ;
    }
    render(){
        return(
            <div className="animation">
                <div className="animation-row-1">
                    <div className="ani-row-1-col-1">
                        ...
                        <p>Finding people to talk about shacks with can be challenging, 
                            but why would you talk about anything else? That’s why we made 
                            Shack — a place where people talk about shacks, together.</p>
                        <button onClick={() => 
                ...
                <div className="animation-row-2">
                    ...
                    <div className="animation-row-2-col-2">
                        ...
                        <p>Unlike real life, conversations in Shack are all about shacks. 
                            Norwegian shacks, shacks in Montana, you name it, we talk about it it.</p>
                    </div>
                </div>
            </div >
